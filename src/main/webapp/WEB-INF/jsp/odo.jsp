							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">									
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="form-field-8"> 出库单号 </label>

										<div class="col-sm-3">
											<input type="text" id="form-field-8" placeholder="R2016052401-001" class="col-xs-10 col-sm-12" />
										</div>
										
										<label class="col-sm-1 control-label no-padding-right" for="id-date-picker-1"> 出库日期 </label>
